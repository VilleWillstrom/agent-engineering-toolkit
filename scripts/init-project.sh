...
install_file ".agent-team/overrides.yaml" ".agent-team/overrides.yaml"
install_file ".agent-team/providers.json" ".agent-team/providers.json"
install_file ".agent-team/platforms.json" ".agent-team/platforms.json"
install_file ".agent-team/session-cleanup.json" ".agent-team/session-cleanup.json"
install_file ".agent-team/github.json" ".agent-team/github.json"
...
mkdir -p "$TARGET_ROOT/.agent-team/reviews" "$TARGET_ROOT/.agent-team/overrides" "$TARGET_ROOT/.agent-team/runtime/sessions" "$TARGET_ROOT/.agent-team/platforms"
touch "$TARGET_ROOT/.agent-team/reviews/.gitkeep" "$TARGET_ROOT/.agent-team/overrides/.gitkeep" "$TARGET_ROOT/.agent-team/runtime/sessions/.gitkeep" "$TARGET_ROOT/.agent-team/platforms/.gitkeep"
...
echo "Codex must ask for telemetry consent, validate provider/platform registries, and request any required restriction override before execution."
