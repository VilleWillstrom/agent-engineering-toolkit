...
mkdir -p "$TARGET_ROOT/.agent-team/reviews" "$TARGET_ROOT/.agent-team/overrides"
touch "$TARGET_ROOT/.agent-team/reviews/.gitkeep" "$TARGET_ROOT/.agent-team/overrides/.gitkeep"
...
echo "Codex must ask for telemetry consent and request any required restriction override before the restricted action begins."